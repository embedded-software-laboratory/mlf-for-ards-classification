...
class Accuracy(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="Accuracy",
...
class AUC(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="AUC", metric_value=FloatValue(metric_value=auc_score), metric_spec=AUC())
...
class F1Score(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="F1-Score",
...
class FPR(ListMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="FPR", metric_value=ListValue(metric_value=fpr), metric_spec=FPR())
...
class MCC(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="MCC",
...
class OptimalProbability(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="Optimal Decision Threshold",
...
class Sensitivity(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="Sensitivity",
...
class Specificity(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="Specificity",
...
class TPR(ListMetricSpec):
    def calculate_metric(self, metric_parameters: dict) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="TPR", metric_value=ListValue(metric_value=tpr), metric_spec=TPR())
