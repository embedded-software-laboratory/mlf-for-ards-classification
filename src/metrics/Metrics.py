...
class Accuracy(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict, stage:str) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="Accuracy" + " " + stage,
...
class AUC(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict, stage:str) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="AUC" + " " + stage,
...
class F1Score(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict, stage:str) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="F1-Score" + " " + stage,
...
class FPR(ListMetricSpec):
    def calculate_metric(self, metric_parameters: dict, stage:str) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="FPR" + " " + stage, metric_value=ListValue(metric_value=fpr),
                                            metric_spec=FPR())
...
class MCC(FloatMetricSpec):
    ...
    def calculate_metric(self, metric_params: dict, stage:str) -> metrics.Models.GenericMetric:
        predicted_class = metric_params['predicted_label']
        true_class = metric_params['true_labels']
        return metrics.Models.GenericMetric(metric_name="MCC" + " " + stage,
...
class Sensitivity(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict, stage:str) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="Sensitivity" + " " + stage,
...
class Specificity(FloatMetricSpec):
    def calculate_metric(self, metric_parameters: dict, stage:str) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="Specificity" + " " + stage,
...
class TPR(ListMetricSpec):
    def calculate_metric(self, metric_parameters: dict, stage:str) -> metrics.Models.GenericMetric:
        ...
        return metrics.Models.GenericMetric(metric_name="TPR" + " " + stage, metric_value=ListValue(metric_value=tpr), metric_spec=TPR())
